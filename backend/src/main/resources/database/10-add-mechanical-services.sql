...
ALTER TABLE mechanical_services RENAME COLUMN service_cost TO expected_service_cost;

INSERT INTO mechanical_services (id, name, expected_execution_time, expected_service_cost)
