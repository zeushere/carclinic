...
INSERT INTO "user" (id, email, login, "password", first_name, last_name)
VALUES ('4c48fd56-c995-40d8-a62b-c5fb4e0c2eaa', 'carclinic.superuser@gmail.com', 'admin',
        '$2a$10$WLTkJpCmni/A8FCxIfPmv.9QbVe5Bg2aDWb.xpx13upjGnygkGHIG', 'admin', 'admin'),
       ('ed3f0b7d-ef0d-43a3-9eed-e5fa2699abc4', 'carclinic.employee@gmail.com', 'employee',
        '$2a$10$BRWEGlT18f1/i2xLFVA1vujQ2gXcuwtshDc8j9anjn4FCdeuXYv9S', 'employee', 'employee'),
       ('cd354993-e308-4c8c-b887-d91a46b1cb32', 'carclinic.user@gmail.com', 'user',
        '$2a$10$mpTaN8UHRhxZihGu1GkO3eKYYaC3fNXxNfYk.o8Dl32VYbTaflvJW', 'user', 'user');
