...
public class SecurityConfig {
    private static final String[] PERMITS_URLS = {
            "/login", "/register","/hello", "/password-reset", "/request-password-reset", "/working-periods/{mechanicalServiceId}","/mechanical-services", "/rabat-code/{code}", "/swagger-ui/**", "/v2/api-docs", "/configuration/ui",
