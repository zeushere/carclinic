...
export const CAR_APPOINTMENT_REQUEST = 'CAR_APPOINTMENT_REQUEST';
export const CAR_APPOINTMENT_SUCCESS = 'CAR_APPOINTMENT_SUCCESS';
export const CAR_APPOINTMENT_FAIL = 'CAR_APPOINTMENT_FAIL';
