        ...
        <Helmet title="Login">
            ...
            <MDBContainer fluid>
                ...
                <MDBCard className='text-black m-5' style={{borderRadius: '25px'}}>
                    <MDBCardBody>
                        <MDBRow>
                            <MDBCol md='6' lg='6' className='mt-5 d-flex flex-column align-items-center justify-content-md-start'>
                ...
                <form className={'login__form'} onSubmit={handleSubmit}>
                    ...
                    <p className={'login__register'}>
                        Nie masz konta?<br/>
                        <Link className={'login__link'} href="#" to={'/#register'}>Zarejestruj się</Link>
                    </p>
